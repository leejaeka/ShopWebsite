...
tl2.to("#box", .5, { left: "20%", scale: 1.3, borderTopColor: "white", borderRightColor: "white", borderLeftColor: "white", borderBottomColor: "#ffffff", borderWidth: 12, boxShadow: '1px 1px 0px 0px rgba(0,0,0,0.09)' })
